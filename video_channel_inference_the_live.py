...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_ch0_path', type=str, default=f'/home2/multicam/dataset/ETRI/202307/KBS_TheLive/clipped/48-78/W1_48-78.mp4',
                        help='video ch0 path') # wide 비디오
    parser.add_argument('--video_ch1_path', type=str, default=f'/home2/multicam/dataset/ETRI/202307/KBS_TheLive/clipped/48-78/C_48-78.mp4',
                        help='video ch1 path') # C 비디오
    parser.add_argument('--video_ch2_path', type=str, default=f'/home2/multicam/dataset/ETRI/202307/KBS_TheLive/clipped/48-78/D_48-78.mp4',
                        help='video ch2 path') # D 비디오
    parser.add_argument('--video_chMC_path', type=str, default=f'/home2/multicam/dataset/ETRI/202307/KBS_TheLive/clipped/48-78/MC_48-78.mp4',
